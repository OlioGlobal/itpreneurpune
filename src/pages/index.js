...
export default function Full_stack() {
  const heroData = {
    title: (
      <p className="text-[24px] sm:text-[28px] md:text-[35px] lg:text-[34px] leading-[1.4]">
        Fresher? No Experience? No Worries! <br className="hidden md:block" />{" "}
        Step Into the World of High-Paying IT Careers
      </p>
    ),
    Partnertitle: "Our Accreditations",
    subtitle: (
      <p className="text-[#FFFFFFCC] leading-[1.3]">
        Join our{" "}
        <span className="text-white font-bold">
          100% Job Guaranteed Courses{" "}
        </span>
        <br /> Trusted by thousands of students
      </p>
    ),
  ...
  const itStruggleData = {
    videoSrc: "/videos/Main_Video.mp4",
    posterSrc: "/thumbnails/main_video.png",
  ...
  return (
    <>
      ...
      <Hero3 data={heroData} pageSource={"Main_Landing_page"} />
      ...
      <CareerTransformation
        ...
        subtitle={
          "With iTpreneur’s JOB ready IT Programs, you can unlock the roles like"
        }
        roles={roles}
      ...
      <WhyChoose
        data={cards}
        heading={"Students Trust ITpreneur Because…"}
        subheading={
          <>
            In today&apos;s fast-paced tech world, businesses are constantly
            looking for skilled IT professionals. Our comprehensive IT
            development program equips you with the expertise to build complete,
            high-quality applications and meet the growing demand for versatile
            tech talent.
          </>
        }
      />
      ...
      <ProgramHighlights
        data={services}
        title={<span>Our Program Highlights</span>}
        subtitle={"Our Promise: 100% Job Guarantee!"}
      />
      <ToolsGrid
        tools={tools}
        title={
      ...
      <Enroll3
        title={
          <p className="text-[24px] sm:text-[28px] md:text-[35px] lg:text-[34px] leading-[1.4]">
            Fresher? No Experience? No Worries!{" "}
            <br className="hidden md:block" /> Step Into the World of
            High-Paying IT Careers
          </p>
        }
        para={
          <span>
