...
export default function Full_stack() {
  ...
  const heroData = {
    title: "Transform into a Job-Ready .NET Developer",
    subtitle: (
  ...
  const roles = [
    ...
    "Web Developer (.NET / React)",
    "Backend Developer (C# / APIs)",
  ...
  const tools = [
    { title: "C#", icon: "/tech/dot1.png" },
    { title: "HTML5", icon: "/tech/dot2.png" },
    { title: "CSS3", icon: "/tech/dot3.png" },
    { title: "JavaScript", icon: "/tech/dot4.png" },
    { title: "Bootstrap", icon: "/tech/dot5.png" },
    { title: "Angular", icon: "/tech/dot6.png" },
    { title: "React", icon: "/tech/dot7.png" },
    { title: "SQL", icon: "/tech/dot8.png" },
    { title: "PL SQL", icon: "/tech/dot9.png" },
    { title: "Git", icon: "/tech/dot10.png" },
    { title: "Jira", icon: "/tech/dot11.png" },
    { title: "Jenkins", icon: "/tech/dot12.png" },
    { title: "JUnit 5", icon: "/tech/dot13.png" },
    { title: "Agile Methodology", icon: "/tech/dot14.png" },
  ];
  ...
  return (
    <>
      <Header2 />
      <ProfessionalMarquee />
      <Hero2 data={heroData} pageSource={"dotnet-youtube"} />
      ...
      <CyberSecurityBenefits
        ...
        title={
          <span>
            Full Stack .NET Developer with <br className="hidden md:block" /> AI
            Integration
          </span>
        }
        subtitle={
          <span>
            In today&apos;s fast-paced tech industry, companies are looking for
            skilled .NET developers who can build secure, high-performing, and
            scalable web applications. <br /> The .NET Full Stack Development
            Program by ITpreneur Pune is designed to help aspiring developers
            master the complete web development lifecycle - from front-end
            design to back-end integration - and become industry-ready
            professionals trusted by leading IT companies.
          </span>
        }
      />
      ...
      <CareerTransformation
        ...
        subtitle={
          "With our industry-aligned curriculum and live projects, you can unlock roles like:"
        }
        roles={roles}
      ...
      <WhyChoose
        ...
        heading={
          <>
            Why Choose Our .NET Full Stack <br className="hidden md:block" />{" "}
            Development Program?
          </>
        }
        subheading={
          <>
            This program blends C#, ASP.NET, MVC, HTML5, CSS, JavaScript,
            Angular/React, SQL, and industry tools like Git, JIRA, and Jenkins —
            enabling you to develop full-fledged enterprise applications from
            scratch. <br /> You’ll gain hands-on experience through real-time
            projects, onsite internships, and placement-focused training,
            ensuring you’re ready to step confidently into your first IT job.
          </>
        }
      />
      ...
      <ProgramHighlights
        ...
        title={
          <span>
            Full Stack .NET Developer + AI Integration{" "}
      ...
      <ToolsGrid
        ...
        description="With Full Stack .NET Developer + AI Integration Program, you'll master these tools step-by-step."
        hideSecondRow={true}
      />
      <WhyChooseITpreneur
        title={"Why .NET Full Stack Development?"}
        para={
          <span>
            The .NET framework powers thousands of business applications
            worldwide — from startups to Fortune 500 companies. With the rise of
            cloud computing and enterprise automation, .NET full-stack
            developers remain in high demand. <br /> By mastering front-end to
            back-end development, you’ll become a versatile professional capable
            of delivering complete web solutions that drive business success.
          </span>
        }
      />
      {/* <HearformStud /> */}
      ...
      <Enroll2
        title={
          <span>
            Take the First Step Toward <br /> Your .NET Career
          </span>
        }
        para={
          <span>
            ...
            <br className="hidden md:block" /> Our career counselor will connect
            with you to guide you <br className="hidden md:block" /> through the
            course details, learning path, and enrollment{" "}
            <br className="hidden md:block" /> process - helping you build a
            successful IT career.
          </span>
        }
        pageSource={"dotnet-youtube"}
      />

      <StickyFooter2
        message={
          "Register yourself for .NET Full Stack Program with 100% Job Guarantee Assurance"
        }
      />
    </>
  );
