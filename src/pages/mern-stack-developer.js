...
export default function Full_stack() {
  const heroData = {
    title:
      "Become a MERN Stack Developer – Secure Your Dream IT Career with 100% Job Guarantee!",
  ...
  const cards = [
    {
      ...
      description:
        "Your success is our promise. With a Day 1 Offer Letter or a refund policy, we ensure you land a job in the IT industry after completing our MERN Stack training.",
      icon: "/icon/gd1.png",
    },
    {
      title: "Hands-On Training",
      description:
        "Work on real-world projects like social media platforms and online learning management systems. Build practical skills using MongoDB, Express.js, React.js, and Node.js that employers demand.",
      icon: "/icon/gd2.png",
    },
    {
    ...
    },
    {
      ...
      description:
        "Learn from industry experts with over 10 years of experience. Get 1-on-1 guidance, doubt resolution, and career coaching to excel in MERN Stack Development.",
      icon: "/icon/gd4.png",
    },
    {
  ...
  const faqData = [
    {
      ...
      answer:
        "This course is ideal for final-year students, fresh graduates, and working professionals looking to upskill or switch careers in IT with MERN Stack training.",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      answer:
        "You’ll build real-world projects like social media platforms and online learning systems using tools like Git, JIRA, and Jenkins to gain practical experience in MERN Stack Development.",
    },
  ];
  const reasons = [
  ...
  return (
    <>
      <Header2 />
      <Hero2 data={heroData} pageSource={"MERN_Developer"} />
      <StudentCarousel
        title={
      ...
      <CyberSecurityBenefits
        ...
        title={
          <span>
            MERN Stack Development <br className="hidden md:block" /> Program Is
            For You If...
          </span>
        }
        subtitle={
          <span>
            ...
            seeking skilled MERN <br className="hidden md:block" /> Stack
      ...
      <CareerTransformation
        ...
        subtitle={
          "With expertise in MERN Stack Development, you can unlock in-demand roles like:"
        }
        roles={roles}
      ...
      <WhyChoose
        ...
        heading={
          <>
            Why Choose iTpreneur’s MERN Stack
            <br className="hidden md:block" /> Development Program?
          </>
        }
        subheading={
          <>
            In today&#39;s rapidly evolving tech landscape, our program equips
            aspiring MERN Stack Developers <br className="hidden md:block" />
            with the skills to build dynamic, full-featured web apps from
            database to UI.
          </>
        }
      />
      ...
      <ProgramHighlights
        ...
        title={
          <span>
            Business MERN Stack Development <br className="hidden md:block" />{" "}
            Program Highlights
          </span>
        }
      />
      <ToolsGrid
        ...
        description="With  Stack Program, you'll master these tools step-by-step."
      />
      <WhyChooseITpreneur
        title={"Why MERN Stack Development?"}
        para={
          "MERN Stack, based entirely on JavaScript, is a leading technology for building modern, scalable web applications. With high demand in industries like e-commerce, social media, and tech startups, mastering MERN Stack training positions you as a versatile developer ready for the future."
        }
      />
      <HearformStud />
