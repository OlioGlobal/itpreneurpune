...
export default function Full_stack() {
  ...
  const cards = [
    {
      ...
      description:
        "Your success is our commitment. With a Day 1 Offer Letter or a refund policy, we ensure you land a job in the IT industry after completing our MEAN Stack training.",
      icon: "/icon/gd1.png",
    },
    {
      title: "Hands-On Training",
      description:
        "Work on real-world projects like social media platforms and online learning management systems. Build practical skills using MongoDB, Express.js, Angular, and Node.js that employers demand.",
      icon: "/icon/gd2.png",
    },
    {
    ...
    },
    {
      ...
      description:
        "Learn from industry experts with over 10 years of experience. Get 1-on-1 guidance, doubt resolution, and career coaching to excel in MEAN Stack Development.",
      icon: "/icon/gd4.png",
    },
    {
  ...
  const faqData = [
    {
      ...
      answer:
        "This course is ideal for final-year students, fresh graduates, and working professionals looking to upskill or switch careers in IT with MEAN Stack training.",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      answer:
        "You’ll build real-world projects like social media platforms and online learning systems using tools like Git, JIRA, and Jenkins to gain practical experience in MEAN Stack Development.",
    },
  ];
  const reasons = [
  ...
  return (
    <>
      <Header2 />
      <Hero2 data={heroData} pageSource={"MEAN_developer"} />
      <StudentCarousel
        title={
      ...
      <CyberSecurityBenefits
        ...
        title={
          <span>
            MEAN Stack Development <br className="hidden md:block" /> Program Is
            For You If...
          </span>
        }
        subtitle={
          <span>
            ...
            seeking skilled MEAN <br className="hidden md:block" /> Stack
      ...
      <CareerTransformation
        ...
        subtitle={
          "With expertise in MEAN Stack Development, you can unlock in-demand roles like:"
        }
        roles={roles}
      ...
      <WhyChoose
        ...
        heading={
          <>
            Why Choose iTpreneur’s MEAN Stack
        ...
        subheading={
          <>
            ...
            aspiring MEAN Stack Developers <br className="hidden md:block" />
      ...
      <ProgramHighlights
        ...
        title={
          <span>
            Business MEAN Stack Development <br className="hidden md:block" />{" "}
            Program Highlights
          </span>
        }
      />
      <ToolsGrid
        ...
        description="With MEAN Stack Program, you'll master these tools step-by-step."
      />
      <WhyChooseITpreneur
        title={"Why MEAN Stack Development?"}
        para={
          "MEAN Stack, based entirely on JavaScript, is a leading technology for building modern, scalable web applications. With high demand in industries like e-commerce, social media, and tech startups, mastering MEAN Stack training positions you as a versatile developer ready for the future."
        }
      />
      <HearformStud />
