...
export default function Hero() {
  return (
    <div className="bg-[url('/icon/itpreneur-banner.webp')] bg-cover bg-center bg-no-repeat bg-[#26784E]">
      <div className="flex-col lg:h-[650px] gap-12 lg:flex-row text-white flex px-[5%] py-10 max-w-screen-2xl mx-auto">
          ...
          <div className="">
            <div className="flex gap-2 flex-wrap">
              {[
                ...
                <div
                  key={index}
                  className="bg-white rounded-full p-3 flex items-center justify-center h-[70px] sm:h-[100px] md:h-[150px] lg:w-32 lg:h-32"
                >
                  <Image
                    src={logo.src}
                    alt={logo.alt}
